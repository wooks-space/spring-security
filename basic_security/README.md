...
* http://localhost:8080/ 페이지로 이동
* 스프링 시큐리티의 기본 로그인 페이지<br>
![img_1.png](img_1.png)
* 스프링 시큐리티가 생성해준 계정 정보를 입력<br>
    * Username은 `user` Password는 런타임 중에 랜덤으로 생성해준다.
    * 아래와 같이 터미널에서 확인할 수 있음.
![img.png](img.png)
* 웰컴 페이지가 정상적으로 출력되었다면 인증성공
  * index.html이 없는 경우<br>![img_2.png](img_2.png)
  * index.html을 구성한 경우<br>![img_3.png](img_3.png)
## Use the HTTP Post Method to verify the user authentication processc